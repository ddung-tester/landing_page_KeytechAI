        ...
        <div ref={stepsRef} className="relative max-w-3xl">
          ...
          <div className="space-y-6">
            {roadmapSteps.map((step, i) => (
              ...
              >
                {/* Circle */}
                <div className="relative z-10 w-10 h-10 rounded-full bg-gradient-to-r from-[#C039B4] to-[#4582F2] transition-all duration-300 hover:opacity-90 border-4 border-white shadow-[0_0_0_1px_#E5E7EB]
                ...
                <div className="flex-1 bg-white border border-[#E5E7EB] rounded-xl p-5 mb-2
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-2">
                    <span className="inline-block bg-[#FDF4FD] text-[#C039B4] text-[11px] font-bold px-2.5 py-1 rounded-full tracking-wide">
                      {step.time}
                    </span>
