              ...
              <div className="p-6">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '7fr 3fr', gap: 12 }}>
                  <div style={{
                    ...
                    <div style={{
                      fontFamily: BV, fontSize: 18, fontWeight: 700,
                ...
                <div style={{
                  ...
                  {SCALE.map((s, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{
                        fontFamily: BV, fontSize: 14, color: '#94A3B8',
                      }}>/ {s.note}</div>
                    </div>
                  ))}
                </div>
                  ...
                  <div key={i} style={{ display: 'flex', alignItems: 'center', flex: 1 }}>
                    <div style={{ textAlign: 'center', flex: 1 }}>
                      <div style={{
                        ...
                        fontFamily: BV, fontWeight: 900, fontSize: 18,
                        margin: '0 auto 6px',
                      }}>{f.num}</div>
                      <div style={{
                        fontFamily: BV, fontSize: 18, fontWeight: 600,
