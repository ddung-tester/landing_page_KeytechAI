            ...
            {submitted ? (
              ...
              >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white border rounded-lg text-[14px] text-[#0F172A] placeholder-[#9CA3AF]
                        ...
                        focus:border-[#1E3A8A] focus:ring-2 focus:ring-[#F0F4FF]
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 bg-[#1E3A8A] hover:bg-[#1E40AF] transition-colors duration-200 text-white font-semibold text-[15px] rounded-lg
